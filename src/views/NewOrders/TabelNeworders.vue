    ...
    export default {
        ...
        computed: {
            ...
            neworders() {
                ...
                return allNewOrders.sort((orderA,orderB)=>orderB.date-orderA.date)
            },
        ...
        methods: {
            ...
            ...mapActions('NewOrders', ['ac_RemoveNewOrder','ac_fetchOrders']),
            // GET FUNCTION ACTIONS IN VUEX VALUES STATUS
            ...mapActions('valuesStatus', ['ac_fetchStatus','ac_addNewValue', 'ac_removeValue']),
            ...
            getVl(){
                let val=JSON.parse(localStorage.getItem('valuesStatus'))
                for(const page in val){
                    val[page].length>0 ? this.ac_addNewValue({status:page,values:val[page]}) : ''
