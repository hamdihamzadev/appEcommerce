...
<script>
  ...
  export default {
    ...
    methods: {
      // GET ACTIONS IN STORE PROGRESS
      ...mapActions('InProgressOrders', ['ac_fetchOrdersInProgress','ac_addOrderInProgress','ac_RemoveOrderProgress']),
