...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ShippedOrders() {
                ...
                Object.values(this.StoreShippedOrders).forEach(tableCtg => {
                    tableCtg.length > 0 ? tableCtg.forEach(order => allOrdersShipped.push(order)) : ''
                })
                return allOrdersShipped.sort( (orderA, orderB) =>  orderA.ref - orderB.ref )
            },
        ...
        methods: {
            ...
            ...mapActions('ShippedOrders', ['ac_fetchOrdersShipped','ac_RemoveOrderShipped','ac_addOrderShipped']),
